...
import cv2
from processfloorplans import compute_edges, compute_vertices
...
img = cv2.imread('../1_3.png', 0)
pathDirections(mapPath('random', 'random', compute_vertices(img), compute_edges(img)))
